...
def load_full_model_resources():
    ...
    try:
        ...
        label_map_path = os.path.join(ASSETS_PATH, 'label_mapping.json')
        ...
        return model, le, model_cols, label_map
...
full_model, le, full_model_columns, label_map = load_full_model_resources()
...
# --- GUNAKAN label_map UNTUK PREDIKSI ---
def predict_label(model, input_df, model_columns, label_map):
